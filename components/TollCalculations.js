...
const TollCalculations = () => {
  ...
  return (
    <div className='flex justify-center mx-7 py-3 my-3  items-center'>
       ...
       <form className='w-full flex justify-center flex-col text-lg bg-orange-100'>
        <input 
       type="text"
       ...
       <OptionalFuel />
        ...
        <button className=' bg-gray-700 text-white rounded-lg cursor-pointer my-4 mx-2 p-2 '>Submit</button>
